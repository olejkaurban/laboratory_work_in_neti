def sorting_list(list_numbers):
    one_nums = list(filter(lambda n: n == 1, list_numbers))
    null_nums = list(filter(lambda n: n == 0, list_numbers))
    list_numbers.clear()
    list_numbers.extend(null_nums)
    list_numbers.extend(one_nums)
